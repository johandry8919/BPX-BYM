...
function runAnimationIN() {
  ...
  if (window.top.spxRenderer && window.top.spxRenderer.fps) {
    ...
    gsap.set("#info0_C", { delay: 0.1, opacity: 0});
    gsap.set("#info0_E", { delay: 0.1, opacity: 0});
    gsap.set("#info8_C", { delay: 0.1, opacity: 0});
    gsap.set("#info8_E", { delay: 0.1, opacity: 0});
    gsap.set("#info4_C", { delay: 0.1, opacity: 0});
    gsap.set("#info5_C", { delay: 0.1, opacity: 0});
    gsap.set("#info6_C", { delay: 0.1, opacity: 0});
    gsap.set("#info7_C", { delay: 0.1, opacity: 0});
